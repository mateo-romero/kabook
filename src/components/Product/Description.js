...
export default function Description({ product }) {
  ...
  return (
    <>
      ...
      {product.features ? (
        <StyledContainIcons>
          {product.features.map((feature) =>
            feature.id === 1 ? (
              <StyledOfered key={feature.id}>
                <GiCookingPot></GiCookingPot>
                <StyledSay>Cocina</StyledSay>
              </StyledOfered>
            ) : feature.id === 2 ? (
              <StyledOfered key={feature.id}>
                <IoIosTv></IoIosTv>
                <StyledSay>Televisor</StyledSay>
              </StyledOfered>
            ) : feature.id === 3 ? (
              <StyledOfered key={feature.id}>
                <AiFillCar></AiFillCar>
                <StyledSay>Estacionamiento gratuito</StyledSay>
              </StyledOfered>
            ) : feature.id === 4 ? (
              <StyledOfered key={feature.id}>
                <MdPool></MdPool>
                <StyledSay>Pileta</StyledSay>
              </StyledOfered>
            ) : feature.id === 5 ? (
              <StyledOfered key={feature.id}>
                <BsSnow></BsSnow>
                <StyledSay>Aire acondicionado</StyledSay>
              </StyledOfered>
            ) : feature.id === 6 ? (
              <StyledOfered key={feature.id}>
                <AiOutlineWifi></AiOutlineWifi>
                <StyledSay>Wifi</StyledSay>
              </StyledOfered>
            ) : feature.id === 7 ? (
              <StyledOfered key={feature.id}>
                <MdPets></MdPets>
                <StyledSay>Apto mascotas</StyledSay>
              </StyledOfered>
            ) : feature.id === 8 ? (
              <StyledOfered key={feature.id}>
                <FaCocktail></FaCocktail>
                <StyledSay>Bar</StyledSay>
              </StyledOfered>
            ) : feature.id === 9 ? (
              <StyledOfered key={feature.id}>
                <FaCoffee></FaCoffee>
                <StyledSay>Desayuno</StyledSay>
              </StyledOfered>
            ) : feature.id === 10 ? (
              <StyledOfered key={feature.id}>
                <FaUtensils></FaUtensils>
                <StyledSay>Restaurante</StyledSay>
              </StyledOfered>
            ) : feature.id === 11 ? (
              <StyledOfered key={feature.id}>
                <FaVideo></FaVideo>
                <StyledSay>Seguridad 24 horas</StyledSay>
              </StyledOfered>
            ) : feature.id === 12 ? (
              <StyledOfered key={feature.id}>
                <FaHandsWash></FaHandsWash>
                <StyledSay>Servicio de limpieza diario</StyledSay>
              </StyledOfered>
            ) : (
              ""
            )
      ...
      <StyledContainKnows>
        <StyledDivKnow>
          <StyledTitleKnow>Normas de la casa</StyledTitleKnow>
          {normas.map((element, index) => (
            <StyledPKnow key={"Nomas" + index}>{element}</StyledPKnow>
          ))}
        </StyledDivKnow>
        <StyledDivKnow>
          <StyledTitleKnow>Salud y seguridad</StyledTitleKnow>
          {salud.map((element, index) => (
            <StyledPKnow key={"Nomas" + index}>{element}</StyledPKnow>
          ))}
        </StyledDivKnow>
        <StyledDivKnow>
          <StyledTitleKnow>Politica de cancelación</StyledTitleKnow>
          {cancelacion.map((element, index) => (
            <StyledPKnow key={"Nomas" + index}>{element}</StyledPKnow>
          ))}
        </StyledDivKnow>
      </StyledContainKnows>
